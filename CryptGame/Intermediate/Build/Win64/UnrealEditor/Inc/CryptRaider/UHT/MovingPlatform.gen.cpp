...
#include "CryptRaider/MovingPlatform.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMovingPlatform() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FRotator();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	CRYPTRAIDER_API UClass* Z_Construct_UClass_AMovingPlatform();
	CRYPTRAIDER_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
...
// End Cross Module References
	...
	template<> CRYPTRAIDER_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	AMovingPlatform::~AMovingPlatform() {}
	struct Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_CryptRaider_Source_CryptRaider_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_CryptRaider_Source_CryptRaider_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2760715741U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_CryptRaider_Source_CryptRaider_MovingPlatform_h_9448093(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_CryptRaider_Source_CryptRaider_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_CryptRaider_Source_CryptRaider_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
